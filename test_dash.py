...
# Import des données
url = "https://raw.githubusercontent.com/LucasRnd/Projet_DataViz/main/dataset_olympics.csv"
...
# Initialiser le modèle de régression logistique avec des paramètres réduits et class_weight
logistic_model = LogisticRegression(random_state=42, C=1, class_weight='balanced')
...
# Initialiser le modèle de forêt aléatoire avec des paramètres réduits et class_weight
